...
function [blobTable,blobFails] = initialSVMcheckAndClean(label,n,imgOrig,family,megapixels,imfillMasks,imfillMasksPartial,imfillMasksClump,netSVM,saveLeafCandidateMasks,filename,destinationDirectory)
    % Blob
