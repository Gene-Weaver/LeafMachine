...
% Choose default command line output for LeafMachineBatchGUI
    ...
    handles.S = load('Networks/network_deeplab_v2_Lexi_dynamicCrop_AWK_SEQ20.mat');
    handles.LeafMachine_SegNet_v1 = handles.S.deeplab_v2_Lexi_dynamicCrop_AWK_SEQ20;
